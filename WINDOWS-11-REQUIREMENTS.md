...
انقر نقراً مزدوجاً على `start-local.cmd`. سيشغل Docker وقاعدة البيانات والترحيلات ثم خادم التطوير. افتح:

- الواجهة: `http://localhost:5173`
- API: `http://localhost:3000`

أوقف النظام بالضغط على `Ctrl+C` في نافذة التشغيل. بيانات PostgreSQL محفوظة في Docker volume ولا تضيع عند إيقاف الحاوية.
