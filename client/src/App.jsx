...
function BatchOutputPanel({ batchResult, products, busy, onGenerate, inform, provider }) {
  ...
  return <article className="panel output-panel batch-output-panel">
    ...
    {batch ? <>
      ...
      <GenerationCostEstimate provider={provider} batchId={batch.id} />
