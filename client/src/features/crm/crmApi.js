...
export const crmApi = {
  ...
  refundSalePayment: (id, payload) => post(`/crm/sales/${encodeURIComponent(id)}/refunds`, payload),
  updateSaleDelivery: (id, payload) => put(`/crm/sales/${encodeURIComponent(id)}/delivery`, payload),
