...
db.exec(`
  ...
  CREATE TABLE IF NOT EXISTS products (
    ...
    generated_at TEXT,
    error_message TEXT,
    generation_mode TEXT NOT NULL DEFAULT 'gallery',
    generation_include_model INTEGER NOT NULL DEFAULT 0,
    generation_model_gender TEXT,
    generation_output_format TEXT,
    generation_creative_style TEXT,
    generation_lifestyle_scene TEXT,
  ...
  CREATE TABLE IF NOT EXISTS product_instagram_images (
    ...
    error_message TEXT,
    completed_at TEXT,
    overlay_brand_id TEXT,
    overlay_brand_tone TEXT,
    overlay_resolved_brand_tone TEXT,
    overlay_alaslee_variant TEXT,
    overlay_cta_text TEXT,
    overlay_layout_json TEXT,
    created_at TEXT NOT NULL,
    updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
    created_by TEXT NOT NULL DEFAULT 'system',
    updated_by TEXT NOT NULL DEFAULT 'system',
